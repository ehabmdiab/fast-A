          ...
          <div className="grid grid-cols-1 items-start gap-y-12 md:grid-cols-2 md:gap-x-8 md:gap-y-16 lg:grid-cols-4">
            <div className="w-full">
              ...
              <p className="text-center">
                Automates data entry and process flows using cutting-edge UI
            ...
            <div className="w-full">
              ...
              <p className="text-center">
                AI learns and optimizes workflows autonomously, enhancing
            ...
            <div className="w-full">
              ...
              <p className="text-center">
                Implement automation effortlessly without needing any coding
            ...
            <div className="w-full">
              ...
              <p className="text-center">
                Ensures data protection with compliance, encryption, and robust
